    ...
    return (
      <div>
        <div className="container my-24 mx-auto md:px-6">
          <section className="">
            <div className="relative overflow-hidden bg-cover bg-no-repeat bg-[50%] bg-[url('https://i0.wp.com/lpatucson.org/central/wp-content/uploads/sites/3/2019/07/iStock-971404756.jpg?fit=1254%2C836&ssl=1')] h-[500px]"></div>
